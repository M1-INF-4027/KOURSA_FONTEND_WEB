...
export default function FichesListPage() {
  ...
  return (
    <Box className="fade-in">
      <PageHeader title="Mes Fiches" description="Fiches de suivi de vos enseignements" />
                  ...
                  <TableBody>
                    {paged.map((f) => (
                      ...
                      >
                        ...
                        <TableCell>{f.nom_delegue || f.delegue?.first_name || '-'}</TableCell>
